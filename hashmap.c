...
hashmap_uint32_t
hashmap_crc32_hash_helper_int_helper(const void *const k, const hashmap_uint32_t l, const hashmap_uint32_t seed,hashmap_uint32_t log2cap) {
  return (hashmap_crc32_hasher(~seed, k, l) * 2654435769u) >> (32u - log2cap);
}
